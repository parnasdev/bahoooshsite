        ...
        <head>
            <xsl:choose>
                <xsl:when test="kml:kml">
                    <title>Locations Sitemap - {{ $data['name'] ?? '' }}</title>
                </xsl:when>
                <xsl:otherwise>
                    <title>XML Sitemap - {{ $data['name'] ?? '' }}</title>
                </xsl:otherwise>
            </xsl:choose>
        ...
        <xsl:choose>
            <xsl:when test="kml:kml">
                ...
                <div id="description">
                    ...
                    <p>
                        This KML Sitemap is generated by <a href="https://bahooosh.com/app/home" target="_blank">Bahooosh.com</a>. It is what search engines like Google use to crawl and re-crawl posts/pages/products/images/archives on your website.								</p>
                </div>
                ...
                <div id="content">
                    ...
                    <p class="expl">
                        <a href="{{ route('sitemap.index') }}">&#8592; Sitemap Index</a>							</p>
            ...
            <xsl:otherwise>
                ...
                <div id="description">
                    ...
                    <h1>XML Sitemap</h1>
                    <p>
                        This XML Sitemap is generated by <a href="https://bahooosh.com/app/home" target="_blank">Bahooosh.com</a>. It is what search engines like Google use to crawl and re-crawl posts/pages/products/images/archives on your website.								</p>
                </div>
