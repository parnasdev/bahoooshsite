                                            ...
                                            <div class="d-flex flex-100 flex-wrap">
                                                @if($child['data']['column'] - count($child['children']) > 0)
                                                    @foreach(range(1 , $child['data']['column'] - count($child['children'])) as $column)
                                                        <button type="button"
                                                                wire:click="$dispatch('openModal', {component: 'panel.utils.components-selector' , arguments:{pageId: @js($pageId) , blockId: @js($child['id'])}})"
                                                                class="image flex-15 d-flex align-items-center justify-content-center py-20 m-right-auto m-left-auto ">
                                                            <svg class="border-dashed-1 border-secondary radius-10 cursor-pointer"
                                                                 width="30"
                                                                 height="30" viewBox="0 0 32 32" fill="none"
                                                                 xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                @foreach($child['children'] as $grand)
                                                    <div
                                                        class="d-flex box-design {{ $child['data']['column'] == 1 ? 'flex-90' : 'flex-45' }} align-items-center mt-15 py-10 px-5 mx-5">
                                                        <div class="flex-12">
                                                            <button type="button" wire:click="deleteComponent({{$grand['id']}})"
                                                                    class="bg-danger parnas-data d-flex align-items-center justify-content-center ml-5"
                                                                    style="border-radius: 10px;width:35px;height:35px">
                                                                <div class="image tooltip d-flex cursor-pointer">
                                                                    <svg width="20" height="20" viewBox="0 0 31 31"
                                                        ...
                                                        <div class="flex-30">
                                                            <span class="f-13">{{ $grand['title'] }}</span>
                                                        </div>

                                                        <div class="flex-48 d-flex justify-content-end">
                                                            <button type="button"
                                                                    wire:click="$dispatch('openModal', {component:'panel.utils.component-setting', arguments:{blockId:@js($grand['id'])}})"
                                                                    class="image d-flex align-items-center justify-content-center py-20">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                                     fill="currentColor" class="bi bi-sliders" viewBox="0 0 16 16">
                                                                    <path fill-rule="evenodd"
