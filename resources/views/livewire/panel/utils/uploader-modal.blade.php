<div>
    <div class="our-service" x-data="{
        ...
        maxItem: @entangle('maxItems').live,
        ...
        <div class="controller-head mb-9 scroller">
            ...
            <div class="main-grid our">
                <div class="flex-services d-flex justify-content-between radius-6">
                    <!--! button 1  -->
                    <div class="our-services-card  flex-48 m-flex-45 px-7"
                         :class="{ 'selected-services': changeTab === 'UploadFile' }" @click="changeTab = 'UploadFile'">
                        <!-- Title -->
                        <div class="paragraph">
                            <span class="f-14">بارگذاری فایل جدید</span>
                        </div>
                    </div>
                    <!--! Button 2 -->
                    <div class="our-services-card flex-48 m-flex-45 px-7"
                        ...
                        <!-- Title -->
                        <div class="paragraph">
                            <span class="f-14">انتخاب از فایل های قبلی</span>
                            {{-- <span class="f-14 bg-info radius-100 py-2 px-10 text-white" x-text="maxItem"></span> --}}
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div x-show="changeTab == 'UploadFile'">
                    <div class="d-flex align-items-center">
                        <label style="font-weight: 600" class="f-13 " for="">بارگذاری در مسیر :</label>
                        <div style="margin-right: 8px" class="select-data flex-24 m-flex-70 mb-10">
                            @if($state=='panel')
                                <div class="select c-s h-2percent-6rem">
                                    <select name="" id="" x-model="direction">
                                        <option value="/">روت</option>
                                        @foreach($directories as $directory)
                                            <option value="{{ $directory['path'] }}">{{ trans($directory['path']) }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            @if($state=='home')
                                <div style="width: 100% !important;" class="select c-s h-2percent-6rem">
                                    <select name="" id="" x-model="direction">
                                        <option value="/">روت</option>
                                        @foreach($directories as $directory)
                                            <option value="{{ $directory['path'] }}">{{ trans($directory['path']) }}</option>
                    ...
                    <div class="drag-area" x-on:drop="dropingFile = false" x-on:drop.prevent="handleFileDrop($event)"
                        ...
                        @if($state=='home')
                            <div class="c-btn pb-5">
                                <button
                                    style="border: none !important;padding: 8px !important;font-size: 14px !important;"
                                    type="button" @click="$refs.files.click()"
                                    class="ancher btn-effect bg-success text-white radius-5">
                                    <div class="circle-solid top-right bg-white"></div>
                                    <svg width="20" height="20" viewBox="0 0 32 32" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                        ...
                        @endif
                        <span class="text-dark f-16 f-bold">حداکثر (MB 64)</span>
                        <input type="file" multiple hidden x-ref="files" @change="uploadFile()">
                        <div x-show="isUpload">
                            <progress max="100" x-bind:value="progress"></progress>
                            <span x-text="progress + '%'" class="f-16"></span>
                        </div>
                        <div x-show="showError">
                            <p class="text-danger f-14 pt-7 m-left-auto alert-invalid">مشکلی در آپلود بوحود آمده است</p>
                        </div>
                    </div>
                </div>
                <div x-show="changeTab == 'File'">
                    <div
                        class="main-data flex-100 d-flex align-items-start m-align-items-stretch justify-content-between">
                        <!--! c-right -->
                        <div class="w-100 box-design bg-white px-5 py-15">
                            ...
                            <div class="mx-10 m-mx-5">
                                <div class="c-data">
                                    <!--! title  -->
                                    <div class="rx-title pb-10 pr-7">
                                        <div class="d-flex align-items-center w-100">
                                            <label style="font-weight: 600" class="f-13 " for="">انتخاب مسیر نمایش :</label>
                                            <div  class="select-data flex-24 m-flex-55 mr-50">
                                                <div style="width: 100% !important;margin-right: 8px" class="select  c-s h-2percent-6rem">
                                                    <select name="" id="" x-model="direction">
                                                        <option value="/">روت</option>
                                                        @foreach($directories as $directory)
                                                            <option
                                                                value="{{ $directory['path'] }}">{{ trans($directory['path']) }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                    ...
                                    <div class="p-table ml-5">
                                        ...
                                        <div class="info-data d-flex justify-content-between mb-10">
                                            ...
                                            <div class="d-flex">
                                                <form wire:submit="submit">
                                                    ...
                                                    <!--? insert data  -->
                                                    <div class="c-btn">
                                                        <button class="btn bg-info text-white radius-5">
                                                            انتخاب و تایید
                                                        </button>
                                                    </div>
                                                </form>
                                        ...
                                        <!-- parent -->
                                        <div
                                            class=" box-item  d-flex flex-wrap flex-100 m-flex-100 py-15 pr-15 m-pr-0 scroller"
                                            style="height: 290px;margin-top: 1rem !important;overflow-y: scroll">
                                            <!-- child -->
                                            {{-- <div class="flex-24 m-flex-47 d-flex align-items-center flex-direction-column bg-white box-design py-20 ml-5 mb-7 cursor-pointer"> --}}
                                            {{-- <div class="image"> --}}
                                            ...
                                            @foreach($uploads ?? [] as $upload)
                                                <div
                                                    class="c-gallery pos-relative bg-white box-design box-shadow-pattern-1 flex-24 m-flex-95 ml-5 mb-7 cursor-pointer radius-10"
                                                    style="height: 180px;">
                                                    @if($state=='panel')
                                                        <button wire:click="deleteFile('{{$upload['path']}}')"
                                                    ...
                                                    @if($state=='home')
                                                        <button wire:click="deleteFile('{{$upload['path']}}')"
                                                                class="btn-delete-upload box-design ">
                                                            <svg width="20" height="20" viewBox="0 0 31 31"
                                                                 fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path d="M12.7852 19.2988L12.7852 15.4647"
                                                                      stroke="#ff383f"
                                                    ...
                                                    <div
                                                        ...
                                                        <label class="checkbox f-10 text-dark">
                                                            <input class="checkbox-input" value="{{ $upload['path'] }}"
                                                                   type="checkbox"
                                                                   :disabled="!selectedFiles.includes(@js($upload['path'])) &&
                                                    ...
                                                    <div
                                                        ...
                                                        @if(str_starts_with($upload['type'] , 'image'))
                                                            <img src="{{ $upload['url'] }}"
                                                                 ...
                                                                 height="100px" alt=""/>
                                                        @elseif(str_starts_with($upload['type'] , 'pdf'))
                                                            <svg class="object-fit-cover" width="100"
                                                                 height="100" viewBox="0 0 14 16" fill="none"
                                                                 xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        @else
                                                            <svg class="object-fit-cover" width="100"
                                                                 height="100" viewBox="0 0 47 47" fill="none"
                                                                 xmlns="http://www.w3.org/2000/svg">
                                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    ...
                                                    <div class="d-flex flex-direction-column justify-content-between"
                                                         style="height: 80px">
                                                        <div class="text pr-7" style="overflow-wrap: break-word;">
                                                            <span
                                                                class="f-14">{{ \Illuminate\Support\Str::limit($upload['filename'] , 30) }}</span>
                                                        </div>
                                                        <div class="text text-align-left pl-7 pb-4">
                                                            <span class="f-14">{{ $upload['size'] }}</span>
                                                            <span class="f-14">{{ $upload['sizeType'] }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            @endforeach
