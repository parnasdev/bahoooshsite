<div>
        ...
        copy(url) {
            if (!window.isSecureContext) {
                ...
                try {
                    ...
                    $dispatch('toast-message' , {message: 'با موفقیت کپی شد' , icon: 'success'})
                } catch (err) {
                    $dispatch('toast-message' , {message: 'مشکلی در ذخیره رخ داده است.' , icon: 'error'})
                }
                    ...
                    <div class="main-grid our">
                        <div class="flex-services d-flex justify-content-between radius-6">
                            ...
                            <div class="our-services-card  flex-48 m-flex-45 px-7"
                                ...
                                <!-- Title -->
                                <div class="paragraph">
                                    <span class="f-14">بخش آپلود</span>
                                </div>
                            </div>
                            <!--! Button 2 -->
                            <div class="our-services-card flex-48 m-flex-45 px-7"
                ...
                <div class="section-details-our-services">
                    <div class="card">
                        <div x-show="changeTab == 'UploadFile'">
                            <div class="select-data flex-24 m-flex-70 mb-10">
                            ...
                            <div class="drag-area" x-on:drop="dropingFile = false"
                                ...
                                <div x-show="showError">
                                    <p class="text-danger f-14 pt-7 m-left-auto alert-invalid">مشکلی در آپلود بوحود آمده
                                        است</p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="mx-10 m-mx-5">
                                        <div class="c-data">
                                            ...
                                            <div class="rx-title pb-10 pr-7">
                                                ...
                                                {{--                                                style="border-radius:100px" x-text="uploads.length"></span>--}}
                                                {{--                                        </div>--}}
                                                <div class="p-rx">
                                                    <div class="rx-border-rectangle"></div>
                                                    <div class="rx-border-rectangle-after"></div>
                                                </div>
                                                <div class="select-data flex-24 m-flex-55 mr-50 ml-10">
                                                    <div class="select c-s h-2percent-6rem">
                                                        <select name="" id="" x-model="direction">
                                                            <option value="">روت</option>
                                                            @foreach($directories as $directory)
                                                                <option
                                                                    value="{{ $directory['path'] }}">{{ $directory['path'] }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                <x-buttons.panel.button type="button" class="ml-10" wire:click="$dispatch('openModal' , {component: 'panel.utils.create-folder' , arguments: {direction: '{{$direction}}'}})">
                                                    ایجاد فولدر
                                                </x-buttons.panel.button>
                                                @if($direction != '')
                                                    @php($array = explode('/' , $this->direction))
                                                    <x-buttons.panel.button type="button" class="ml-10" color="primary" wire:click="$dispatch('openModal' , {component: 'panel.utils.create-folder' , arguments: {direction: '{{ count($array) == 2 ? $array[0] : '' }}' , folder: '{{ count($array) == 2 ? $array[1] : $array[0] }}' , old: '{{ $this->direction }}' , editMode: true}})">
                                                        ویرایش فولدر
                                                    </x-buttons.panel.button>

                                                    <x-buttons.panel.button type="button" color="danger" wire:click="deleteFolder()">
                                                        حذف فولدر
                                                    </x-buttons.panel.button>
                                                @endif
                                            </div>
                                            ...
                                            <div class="p-table ml-5">
                                                ...
                                                <div class="info-data d-flex justify-content-between mb-10">
                                                    ...
                                                    <!--! Result  -->
                                                    @if($route == 'panel.fileManger.tinymce5')
                                                        <div class="d-flex">
                                                ...
                                                <!-- parent -->
                                                <div
                                                    class="box-design d-flex flex-wrap flex-100 m-flex-100 py-15 pr-15 m-pr-0 scroller"
                                                    style="height: 290px">
                                                    <!-- child -->
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="text pr-7"
                                                                    ...
                                                                    <span class="f-14" @click="copy('{{ $upload['url'] }}')">    <x-utils.icons icon="document" width="15" height="15"/>{{ \Illuminate\Support\Str::limit($upload['filename'] , 30) }}</span>
    ...
    <script>
        document.addEventListener('prs-file-manager-editor', function (event) {
            let {urls} = event.detail
            console.log(urls)
            ...
            FileBrowserDialogue.mySubmit(urls[0]);
        });
    </script>
</div>
