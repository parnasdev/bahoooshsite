    ...
    <header class="header-m isMobile" style="display: none;" x-data>
        <div class="row-header">
            ...
            <div class="info-detail d-flex align-items-center justify-content-end flex-50">
                ...
                <div class="image px-5 ml-10 d-flex justify-content-center align-items-center radius-5 cursor-pointer pos-relative"
                     style="height: 35px">
                    <div class="line"></div>
                ...
                <div class="image px-5 d-flex justify-content-center align-items-center radius-5 cursor-pointer pos-relative"
                     style="height: 35px">
                    <div class="line"></div>
                    <div class="sequare"></div>
                    <div class="image mt-5">
                        <a href="https://parnas.agency/" target="_blank" class="d-flex align-items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23"
                                 viewBox="0 0 69.375 59.209">
                                <g id="Layer_2" data-name="Layer 2" transform="translate(1.755 1.97)">
                                    <g id="Layer_1" data-name="Layer 1" transform="translate(0 0)">
                                        <path id="Path_1344" data-name="Path 1344"
                                              d="M62.613,57.962l-20.68-36.3L15.31,67.943"
                                              transform="translate(-8.807 -12.069)" fill="none" stroke="#212e47"
                                              stroke-linecap="round" stroke-miterlimit="10" stroke-width="3"></path>
                                        <path id="Path_1345" data-name="Path 1345"
                                              d="M50.719,64.6H62.639L55.028,50.98,42.19,73.562"
                                              transform="translate(-21.9 -26.351)" fill="none" stroke="#212e47"
                                              stroke-linecap="round" stroke-miterlimit="10" stroke-width="3"></path>
                                        <path id="Path_1351" data-name="Path 1351"
                                              d="M50.22,48.853H91.676L64.468,2.96,61.1,8.715,80.106,41.206H75.264"
                                              transform="translate(-25.812 -2.96)" fill="none" stroke="#212e47"
                                              stroke-linecap="round" stroke-miterlimit="10" stroke-width="3"></path>
                                        <path id="Path_1352" data-name="Path 1352"
                                              d="M10.277,48.853H2.63L29.833,2.96,33.2,8.715,14.2,41.206"
                                              transform="translate(-2.63 -2.96)" fill="none" stroke="#212e47"
                                              stroke-linecap="round" stroke-miterlimit="10" stroke-width="3"></path>
                                    </g>
                                </g>
                            </svg>
        ...
        <div class="menu-l-mobile box-design" style="display: none;">
        ...
        $('body').css({
            'overflow-y': 'scroll'
                ...
                <div class="c-row">
                    ...
                    <div class="text my-6">
                        <div class="text">
                            <div class="text time d-flex justify-content-center mt-6">
                                <span class="f-10 f-bold text-white">{{ $greeting }}; امروز
                    ...
                    <div class="p-profile d-flex align-items-center justify-content-between rtl py-5 px-10">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!--? text -->
                            <div class="text px-2">
                                <h6 class="text-white">{{ user()->name }} {{ user()->family }}</h6>
                ...
                <div class="local-controller scroller">
                    {{-- data list --}}
