            ...
            <div class="w-full items-center pt-14  flex-col">
                <div class="row-one">
                    <div class="text-main max-[600px]:w-full flex gap-3 sm:w-full flex-col items-center w-1/2">
                        ...
                        <button
                            class="btn-base bg-white text-black hover:bg-black hover:text-white border-2 border-black mt-2 w-64 max-[600px]:w-48 gap-5">
                            مشاهده نمونه کار‌ها
                        </button>
                    </div>
                    <div class="border-row-one max-[600px]:mt-20 relative flex justify-content-end mt-16 mb-12 border-t-2 border-black">
                        <img  width="70" src="img/view/png/folder-img-left.png" alt="" class="img-left   absolute">
                        <img width="40" src="img/view/png/img-arrow-right.png" alt=""
                             class="img-right top-0 right-2 absolute">
                    </div>
                </div>
                <div class="row-two">
                    <div x-data class="list-portfolio mb-12 mt-28 w-full grid max-[600px]:grid-cols-1 : sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-3">
                        <template x-for="item in 16">
                            <div class="item mt-2 bg-white rounded-3xl h-72 w-full flex flex-col items-center p-3">
                                <div class="img w-full flex items-center mt-2 justify-center  h-20">
                                    <img width="130" src="img/view/png/pezhvak.png" alt="">
                                </div>
                                <h3 class="text-base text-sm  mt-3 bolX">اسباب بازی فروشی پژواک هابی</h3>
                                <a href=""
                                ...
                                <p class="text-center leading-5	text-gray mt-3 text-small medium">
                                    توضیحی درباره کسب و کار ساخته شده با باهوش در این قسمت نوشته می شود که نهاینا سه خط
                                    باید باشد وگرنه دیزاین به هم میریزه.
                                </p>
                            </div>
                        </template>
                ...
                <div class="row-three mb-20 mt-6 flex justify-center w-full">
                    <div class="text-end flex gap-3 sm:w-full flex-col items-center max-[600px]:w-full w-1/2">
                        ...
                        <button class="btn-base bg-black text-white hover:bg-white hover:text-black border-2 border-black mt-2 w-64 gap-5">
