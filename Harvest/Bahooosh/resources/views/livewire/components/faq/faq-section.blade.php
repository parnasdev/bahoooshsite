<div>
                    ...
                    <div class="faq-thumbnail bg-white rounded-2xl flex flex-col w-full">
                        <div @click="faq = @js($index)"
                            ...
                            <div class="start w-4/5 flex gap-3 items-center justify-start">
                                ...
                                <h4 class="text-normal bolX">{{ $faq['title'] }}</h4>
                            </div>
                            <div class="end">
                                <svg class="arrow" :class="faq===@js($index)? 'arrow-active':''"
                        ...
                        <div style="display: none" x-show="faq===@js($index)" x-collapse.duration.1000ms class="w-full">
    ...
    @else
        <x-bahooosh::faq.faq-edit-form :$blockForm/>
    @endif
</div>
