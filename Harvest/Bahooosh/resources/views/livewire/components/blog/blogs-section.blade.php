<div>
        ...
        <div class="p-blogs w-full">
            <div class="show-desktop">
                <div class="row-title w-full flex justify-between items-end">
                    ...
                    <x-buttons.home.button-o href="{{ $block->data['btn_link'] }}" class="bg-white text-black border-2 border-black hover:bg-black hover:text-white px-7">
                        {{ $block->data['btn_text'] }}
            ...
            <div class="show-desktop w-full">
                <div class="list-blogs w-full my-6 grid grid-cols-3 gap-2">
                    @foreach($posts as $post)
                        <livewire:bahooosh::thumbnails.blog-thumbnail :$post />
                    @endforeach
                </div>
            </div>
    ...
    @else
        <x-bahooosh::blogs.blogs-edit-form :$blockForm :oldSelected="$oldSelected"/>
    @endif
</div>
