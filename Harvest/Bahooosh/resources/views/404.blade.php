<x-layouts.app>
    {{--404--}}
    <div x-data x-show="false" class="not-found flex flex-col items-center justify-center">
        ...
        <button
            class="btn-base bg-black text-white hover:bg-white hover:text-black border-2 border-black mt-8 w-72 gap-5">
    ...
    {{--500--}}
    <div x-data x-show="true" class="not-found flex flex-col items-center justify-center">
        <img width="300" src="/img/view/png/500.png" alt="">
        <h2 class="text-2xl extraBold">احتمالا مشکلی به وجود آمده است!</h2>
        <p class="text-gray leading-6 max-[600px]:w-11/12 text-small w-2/6 text-normal text-center mt-4 medium">
            لطفا دقایقی دیگر، دوباره امتحان کنید!
            <br>
            یا با استفاده از دکمه زیر به صفحه اصلی فروشگاه ساز باهوش برگردید …
        </p>
        <button
            class="btn-base bg-black text-white hover:bg-white hover:text-black border-2 border-black mt-8 w-72 gap-5">
            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="21" viewBox="0 0 29.177 26.746">
