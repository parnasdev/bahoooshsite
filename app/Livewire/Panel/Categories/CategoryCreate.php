...
class CategoryCreate extends Component
{
    ...
    {
        $this->category->cat_type = $this->cat_type;
        $this->category->post_type = $this->post_type;
    }
    ...
    public function render()
    {
        ...
        return view('livewire.panel.categories.category-create', compact('categories'));
    }
    ...
    public function submit(): void
    {
        ...
        $category = Category::query()->create($this->category->all());

        $this->syncFiles($this->files, $category);
